...
- `super_scopus_search_DOIs`: Get DOIs from `super_scopus_search`, which can then be imported into a reference manager, such as Zotero, to create a list of references.
